...
exports.FacultyMemberModel = void 0;
...
const facultySchema = new mongoose_1.Schema({
    ...
    name: {
        type: userNameSchema, // Use the sub-schema correctly here
        required: [true, 'Name is required'],
    },
    gender: {
        type: String,
        enum: {
            values: member_constant_1.Gender,
    ...
    bloodGroup: {
        type: String,
        enum: {
            values: member_constant_1.BloodGroup,
...
facultySchema.statics.isUserExists = function (id) {
    return __awaiter(this, void 0, void 0, function* () {
        const existingUser = yield exports.FacultyMemberModel.findOne({ id });
        return existingUser;
    });
};
exports.FacultyMemberModel = (0, mongoose_1.model)('Faculty', facultySchema);
