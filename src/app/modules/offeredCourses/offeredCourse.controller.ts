...
export class OfferedCourseControllers {
    static createOfferedCourse = catchAsync(async (req, res) => {
        ...
        sendResponse(
            ...
            201,
            true,
            'offered course is created successfully',
            result,
        );
    });
    ...
    static getAllOfferedCourse = catchAsync(async (req, res) => {
        ...
        sendResponse(
            ...
            200,
            true,
            'offered course retrieved successfully',
            result,
        );
    });
    ...
    static updateOfferedCourse = catchAsync(async (req, res) => {
        ...
        sendResponse(
            ...
            200,
            true,
            'offered course updated successfully',
            result,
        );
    });

    static deleteOfferedCourse = catchAsync(async (req, res) => {
        const result = await OfferedCourseServices.deleteOfferedCourse(
            req.params.id,
        );
        sendResponse(
            res,
