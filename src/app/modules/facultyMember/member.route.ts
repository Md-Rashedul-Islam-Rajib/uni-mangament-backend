...
FacultyMemberRouter.patch(
    '/:id',
    validateRequest(updateFacultyMemberValidationSchema),
    FacultyMemberControllers.updateFacultyMember,
);

FacultyMemberRouter.delete(
    '/:id',
    FacultyMemberControllers.deleteFacultyMember,
);
