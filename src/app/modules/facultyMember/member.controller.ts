...
export class FacultyMemberControllers {
    static getAllFacultyMembers = catchAsync(
        async (req: Request, res: Response) => {
            const result = await FacultymemberServices.getAllFacultyMembers(
                req.query,
            );
            ...
            sendResponse(
                ...
                200,
                true,
                'Faculty members are retrieved successfully',
                result,
            );
        },
    );
    ...
    static getSingleFacultyMember = catchAsync(async (req, res) => {
        ...
        sendResponse(
            ...
            200,
            true,
            'Faculty member is retrieved successfully',
            result,
        );
    });
    ...
    static updateFacultyMember = catchAsync(async (req, res) => {
        ...
        sendResponse(
            ...
            200,
            true,
            'Faculty member is updated successfully',
            result,
        );
    });
    ...
    static deleteFacultyMember = catchAsync(async (req, res) => {
        ...
        sendResponse(
            ...
            200,
            true,
            'Faculty member is deleted successfully',
            result,
        );
    });
}
