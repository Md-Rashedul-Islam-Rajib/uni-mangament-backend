...
import {
    createRegSemesterValidationSchema,
    upadateRegSemesterValidationSchema,
} from './regSemester.zodSchema';
import { RegSemesterControllers } from './regSemester.controller';

const RegSemesterRouter: Router = Router();

RegSemesterRouter.post(
    '/create-semester-registration',
    validateRequest(createRegSemesterValidationSchema),
...
RegSemesterRouter.patch(
    '/:id',
    validateRequest(upadateRegSemesterValidationSchema),
    RegSemesterControllers.updateRegSemester,
);
