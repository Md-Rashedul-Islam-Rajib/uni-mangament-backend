...
export class RegSemesterControllers {
    ...
    static getSingleRegSemester = catchAsync(async (req, res) => {
        const result = await RegSemesterServices.getSingleRegSemester(
            req.params.id,
        );
        sendResponse(
            res,
    ...
    static updateRegSemester = catchAsync(async (req, res) => {
        const result = await RegSemesterServices.updateRegSemester(
            req.params.id,
            req.body,
        );
        sendResponse(
    ...
    static deleteRegSemester = catchAsync(async (req, res) => {
       await RegSemesterServices.deleteRegSemester(
            req.params.id,
        );
        sendResponse(
            res,
            200,
            true,
            'Semester registration is deleted successfully',
        );
    });
}
